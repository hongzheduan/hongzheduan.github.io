(function () {
  ...
  styleEl.textContent = [
    ...
    '}',
    '#bzw-btn:hover{transform:scale(1.06);box-shadow:0 6px 28px rgba(59,130,246,.6);}',
    ...
    '@media(max-width:480px){',
      '#bzw-panel{width:calc(100vw - 20px);right:10px;bottom:130px;}',
      '#bzw-btn{bottom:90px;right:14px;height:44px;padding:0 14px 0 10px;gap:6px;}',
