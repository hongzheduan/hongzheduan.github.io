...
TICKER_SECTOR_OVERRIDE = {
    ...
    # --- SIC misclassifications: correct to GICS-aligned sectors ---
    # Consumer Cyclical (travel, cruise, delivery, e-commerce)
    "ABNB":  "Consumer Cyclical",    # Airbnb (vacation rentals)
    "BKNG":  "Consumer Cyclical",    # Booking Holdings (online travel)
    "CCL":   "Consumer Cyclical",    # Carnival (cruise lines)
    "DASH":  "Consumer Cyclical",    # DoorDash (food delivery)
    "EBAY":  "Consumer Cyclical",    # eBay (e-commerce marketplace)
    "EXPE":  "Consumer Cyclical",    # Expedia (online travel)
    "MELI":  "Consumer Cyclical",    # MercadoLibre (Latin America e-commerce)
    "NCLH":  "Consumer Cyclical",    # Norwegian Cruise Line
    "POOL":  "Consumer Cyclical",    # Pool Corp (pool supplies distribution)
    "RCL":   "Consumer Cyclical",    # Royal Caribbean (cruise lines)
    "UBER":  "Consumer Cyclical",    # Uber (rideshare/delivery)
    # Financial Services (payments, fintech, financial data)
    "CPAY":  "Financial Services",   # Corpay (commercial payments)
    "FIS":   "Financial Services",   # Fidelity National Info Services (payment tech)
    "FISV":  "Financial Services",   # Fiserv (payment processing)
    "GPN":   "Financial Services",   # Global Payments (payment processing)
    "MA":    "Financial Services",   # Mastercard (payments network)
    "MSCI":  "Financial Services",   # MSCI (financial indices & analytics)
    "PYPL":  "Financial Services",   # PayPal (digital payments)
    "V":     "Financial Services",   # Visa (payments network)
    # Technology (IT services, software, electronic equipment)
    "ACN":   "Technology",           # Accenture (IT consulting & services)
    "AKAM":  "Technology",           # Akamai (CDN / cloud security)
    "CSGP":  "Real Estate",          # CoStar Group (commercial RE data)
    "FICO":  "Technology",           # Fair Isaac (analytics software / FICO score)
    "GLW":   "Technology",           # Corning (optical fiber / display glass)
    "GRMN":  "Technology",           # Garmin (GPS / electronic devices)
    "IT":    "Technology",           # Gartner (IT research & advisory)
    "KEYS":  "Technology",           # Keysight (electronic test equipment)
    "LRCX":  "Technology",           # Lam Research (semiconductor equipment)
    "TRMB":  "Technology",           # Trimble (positioning / field technology)
    "ZBRA":  "Technology",           # Zebra Technologies (enterprise mobility tech)
    # Healthcare (life sciences tools & services)
    "DHR":   "Healthcare",           # Danaher (life sciences instruments)
    "TMO":   "Healthcare",           # Thermo Fisher Scientific (life sciences tools)
    # Basic Materials (packaging)
    "AMCR":  "Basic Materials",      # Amcor (flexible & rigid packaging)
}
