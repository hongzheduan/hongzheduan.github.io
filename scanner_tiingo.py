...
SHARES_OUTSTANDING_OVERRIDE = {
    ...
    "CVNA": lambda s: (s or 0) * 5 if (s or 0) < 50_000_000 else s,    # 5-for-1 split May 2026; EDGAR pre-split ~32M; heals after Q2 2026 10-Q
}
...
def compare_with_yfinance(df):
    ...
    lines += [
        ...
        "  CVNA   shares × 5    (5-for-1 split May 2026; EDGAR pre-split ~32M; heals after Q2 2026 10-Q ~Aug 2026)",
        "",
